...
-- INSERT INTO 
-- build(id,product_name,
-- customer_name,country,gender,
-- email,price) VALUES
...
-- 
-- SELECT SUM(price) AS 'Amarican price all'
-- FROM build
-- SELECT product_name AS 'Sản Phẩm', MIN(price) AS 'Giá tiền'
-- FROM build
-- GROUP BY product_name

-- SELECT country,MAX(price) AS 'giá tiền'
-- FROM build
-- GROUP BY country


-- SELECT gender , sum(price) AS 'tổng giá tiền'
-- FROM build
-- GROUP BY gender

-- UPDATE  build SET price = 1225 WHERE product_name = 'Tiêu bắc'
-- SELECT  * from build where product_name = 'Tiêu bắc'
-- 
-- DELETE FROM build
